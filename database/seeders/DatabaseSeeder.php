...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        VpsOs::create([
            'name' => 'Windows',
            'os_id' => 1145,
            'image_url' => 'https://api.devhosting.jinom.ai/os/windows.png',
        ]);
        VpsOs::create([
            'name' => 'Ubuntu',
            'os_id' => 1017,
            'image_url' => 'https://api.devhosting.jinom.ai/os/ubuntu.png',
        ]);
        VpsOs::create([
            'name' => 'Centos',
            'os_id' => 961,
            'image_url' => 'https://api.devhosting.jinom.ai/os/centos.png',
            // 'image_url' => 'http://localhost:8000/os/centos.png',
        ]);
    }
}
